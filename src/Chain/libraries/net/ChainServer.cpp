    ...
    namespace net {
        namespace detail {
            ...
            public:
                ...
                std::shared_ptr<thinkyoung::blockchain::ChainDatabase> _chain_db;
                ...
                ChainServerImpl(std::shared_ptr<thinkyoung::blockchain::ChainDatabase> chain_ptr, uint16_t port)
                    : _chain_db(chain_ptr),
                ...
                void accept_loop() {
                    while (!_accept_loop_handle.canceled()) {
                        ...
                        finished_future.on_complete([=](fc::exception_ptr ep) { master_thread->async([=] {
                            ...
                            if ((int)_idle_threads.size() < _target_thread_count) {
                ...
                void handle_get_blocks_from_number(fc::tcp_socket& connection_socket) {
                    try {
                        ...
                        fc::raw::pack(connection_socket, uint64_t(0));
        ...
        thinkyoung::net::ChainServer::ChainServer(std::shared_ptr<thinkyoung::blockchain::ChainDatabase> chain_ptr, uint16_t port)
        ...
        uint16_t thinkyoung::net::ChainServer::get_listening_port()
        {
            return my->_server_socket.get_port();
        }

    }
} //namespace thinkyoung::net
