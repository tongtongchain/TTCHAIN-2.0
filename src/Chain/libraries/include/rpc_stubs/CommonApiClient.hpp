...
namespace thinkyoung {
    namespace rpc_stubs {
        ...
        public:
            ...
            std::string blockchain_export_fork_graph(uint64_t start_block = fc::json::from_string("1").as<uint64_t>(), uint64_t end_block = fc::json::from_string("-1").as<uint64_t>(), const thinkyoung::blockchain::FilePath& filename = fc::json::from_string("\"\"").as<thinkyoung::blockchain::FilePath>()) const override;
