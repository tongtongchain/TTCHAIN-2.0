...
namespace thinkyoung {
    namespace cli {
        ...
        private:
			...
			static void f_blockchain_get_fullblock(std::ostream& out, const fc::variants& arguments, const fc::variant& result, ClientRawPtr client);
			static void f_blockchain_get_fullblock_list(std::ostream& out, const fc::variants& arguments, const fc::variant& result, ClientRawPtr client);
