    ...
    namespace wallet {
        ...
        class Wallet {
          public:
            ...
            * @return void
            */
            void                   set_last_scanned_block_numbers(vector<uint64_t> block_nums);
            void                    set_last_scanned_block_numbers_for_alp(vector<uint64_t> block_nums);
            /**
            * Get wallet property of last scanned block number.
            *
            * @return uint32_t
            */
            vector<uint64_t>               get_last_scanned_block_numbers()const;
            vector<uint64_t>                get_last_scanned_block_numbers_for_alp()const;
            ...
            */
			...
			void                               unlock_waiting(const string& password, uint32_t timeout_seconds);
			void                               unlock_later();
            /**
            ...
            * @return void
            */
            void start_scan(vector<uint64_t> start_block_nums, const uint64_t limit);
            /**
            ...
            */
			...
			void sign_block1(SignedBlockHeader& header, PublicKeyType signee)const;
            ...
            * @return void
            */
			void cache_transaction(WalletTransactionEntry& transaction_entry, bool seed, bool store = true);
			bool is_seed_node();
