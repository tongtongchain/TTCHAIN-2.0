...
namespace thinkyoung {
    namespace wallet {
        ...
        public:
			...
			void store_raw_transaction(const SignedTransaction& trx, const time_point_sec block_timestamp);
			void store_transaction(const TransactionData& transaction);
			void confirm_transaction(const TransactionIdType& transactionId, uint64_t blockNum);
