    ...
    namespace wallet {
        namespace detail {
            ...
            public:
                ...
                */
                SecretHashType get_secret(uint64_t block_num,
                    const PrivateKeyType& delegate_key)const;

				void scan_block(SignedBlockHeader block_header); // uint64_t block_num);
                ...
                void scan_block_experimental(uint64_t block_num,
                ...
                * @return void
                */
                void start_scan_task(vector<uint64_t> start_block_nums, const uint64_t limit);
                void scan_accounts();
                void scan_balances();
