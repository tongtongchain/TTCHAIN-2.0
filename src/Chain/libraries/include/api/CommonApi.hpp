...
namespace thinkyoung {
    namespace api {
        ...
        public:
             ...
             */
            virtual std::vector<thinkyoung::blockchain::AlpTrxidBalance> blockchain_get_alp_account_balance_entry(uint64_t block_num) = 0;
            /**
			...
			virtual uint32_t blockchain_get_total_seednode() const = 0;
			virtual uint32_t blockchain_get_total_status_nodes() const = 0;
			virtual uint32_t status_node_get_index() const = 0;
			virtual uint32_t status_node_unlocked_wallets_count() const = 0;
            /**
             * Returns the current head block number.
             *
             * @return uint32_t
             */
            virtual uint64_t blockchain_get_block_count(const string& nodeindex) const = 0;

            virtual uint64_t status_node_close_wallet(const string& index) const = 0;
            virtual uint64_t status_node_lock_wallet(const string& index) const = 0;
            /**
             ...
             * @return oblock_entry
             */
			virtual thinkyoung::blockchain::oFullBlockEntry blockchain_get_block(const std::string& block) const = 0;
			virtual thinkyoung::blockchain::oFullBlockEntry blockchain_get_fullblock(const std::string& block) const = 0;
			virtual std::vector<oFullBlockEntry> blockchain_get_fullblock_list(const std::string& block, const uint32_t limit = 1000) const = 0;
			/**
             ...
             * @return account_entry_array
             */
            virtual std::vector<thinkyoung::blockchain::AccountEntry> blockchain_list_active_delegates(uint64_t first = fc::json::from_string("0").as<uint64_t>(), uint64_t count = fc::json::from_string("11").as<uint64_t>()) const = 0;
            /**
             ...
             * @return account_entry_array
             */
            virtual std::vector<thinkyoung::blockchain::AccountEntry> blockchain_list_delegates(uint64_t first = fc::json::from_string("0").as<uint64_t>(), uint64_t count = fc::json::from_string("20").as<uint64_t>()) const = 0;
            /**
             ...
             */
            virtual std::vector<thinkyoung::blockchain::BlockEntry> blockchain_list_blocks(uint64_t max_block_num = fc::json::from_string("-1").as<uint64_t>(), uint64_t limit = fc::json::from_string("20").as<uint64_t>()) = 0;
            /**
             ...
             */
            virtual std::vector<std::string> blockchain_list_missing_block_delegates(uint64_t block_number) = 0;
            /**
             ...
             * @return string
             */
            virtual std::string blockchain_export_fork_graph(uint64_t start_block = fc::json::from_string("1").as<uint64_t>(), uint64_t end_block = fc::json::from_string("-1").as<uint64_t>(), const thinkyoung::blockchain::FilePath& filename = fc::json::from_string("\"\"").as<thinkyoung::blockchain::FilePath>()) const = 0;
            /**
             * returns a list of all blocks for which there is a fork off of the main chain.
             *
             * @return map<uint32_t, vector<fork_entry>>
             */
            virtual std::map<uint64_t, std::vector<thinkyoung::blockchain::ForkEntry>> blockchain_list_forks() const = 0;
            /**
             ...
             */
            virtual std::vector<thinkyoung::blockchain::SlotEntry> blockchain_get_delegate_slot_entrys(const std::string& delegate_name, uint64_t limit = fc::json::from_string("\"10\"").as<uint64_t>()) const = 0;
            /**
             ...
             */
			//virtual std::vector<thinkyoung::blockchain::EventOperation> blockchain_get_events(uint64_t block_number, const thinkyoung::blockchain::TransactionIdType& trx_id) const = 0;
			virtual std::vector<thinkyoung::blockchain::EventOperation> blockchain_get_events(const std::string& block_number, const thinkyoung::blockchain::TransactionIdType& trx_id) const = 0;
            /**
             ...
             */
            virtual std::vector<fc::variant_object> status_nodes_info(bool not_firewalled = fc::json::from_string("false").as<bool>()) const = 0;
            virtual std::vector<fc::variant_object> status_node_unlocked_wallets_list(bool not_firewalled = fc::json::from_string("false").as<bool>()) const = 0;
             ...
             */
            virtual std::vector<thinkyoung::wallet::PrettyTransaction> wallet_account_transaction_history(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>(), const std::string& asset_symbol = fc::json::from_string("\"\"").as<std::string>(), int64_t limit = fc::json::from_string("0").as<int64_t>(), uint64_t start_block_num = fc::json::from_string("0").as<uint64_t>(), uint64_t end_block_num = fc::json::from_string("-1").as<uint64_t>()) const = 0;
            /**
             * Lists transaction history for the specified account.
             *
             * @param account_name the name of the account for which the transaction history will be returned, "" for
             ...
             * @return pretty_transactions
             */
            virtual std::vector<thinkyoung::wallet::PrettyTransaction> wallet_transaction_history_splite(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>(), const std::string& asset_symbol = fc::json::from_string("\"\"").as<std::string>(), int64_t limit = fc::json::from_string("0").as<int64_t>(), int32_t transaction_type = fc::json::from_string("\"2\"").as<int32_t>()) const = 0;
            /**
             ...
             */
            virtual void wallet_rescan_blockchain(uint64_t start_block_num = fc::json::from_string("0").as<uint32_t>(), uint32_t limit = fc::json::from_string("-1").as<uint32_t>()) = 0;
            /**
