...
namespace thinkyoung {
    namespace blockchain {
        ...
        */
		...
		FC_DECLARE_DERIVED_EXCEPTION(no_status_node_connected, thinkyoung::blockchain::sandbox_error, 50001, "no status node connected");
		FC_DECLARE_DERIVED_EXCEPTION(unlock_waiting, thinkyoung::blockchain::sandbox_error, 50002, "unlock waiting");

		FC_DECLARE_DERIVED_EXCEPTION(forcely_close_wallet, thinkyoung::blockchain::sandbox_error, 50003, "forcely close in non-status node");
		FC_DECLARE_DERIVED_EXCEPTION(index_invalid, thinkyoung::blockchain::sandbox_error, 50004, "invalid index of wallet closed");
		FC_DECLARE_DERIVED_EXCEPTION(cant_exec_on_non_status, thinkyoung::blockchain::sandbox_error, 50005, "can't run on non-status node");
