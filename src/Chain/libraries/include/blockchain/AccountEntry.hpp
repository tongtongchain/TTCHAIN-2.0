...
namespace thinkyoung {
    namespace blockchain {
        ...
        struct DelegateStats
        {
            ...
            uint8_t                           pay_rate = 0;
            map<uint64_t, PublicKeyType>    signing_key_history;

            uint64_t                          last_block_num_produced = 0;
        ...
        struct AccountEntry
        {
            ...
            */
            ...
            void              set_signing_key(uint64_t block_num, const PublicKeyType& signing_key);
