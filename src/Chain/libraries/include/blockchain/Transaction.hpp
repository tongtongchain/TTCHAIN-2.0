...
namespace thinkyoung {
    namespace blockchain {
		...
		struct TransactionSendingState
		{
			string				  seedAddr;
			fc::time_point_sec    sentTime;
			//TransactionSendingState(string& addr, fc::time_point_sec& secs)
			//{
			//	seedAddr = addr;
			//	sentTime = secs;
			//}
        ...
        struct AlpBalanceEntry{
            ...
            std::multimap<uint64_t, AlpTrxidBalance> alp_block_sort;
        };
        struct TransactionLocation {
            TransactionLocation(uint64_t block_num = 0, uint32_t trx_num = 0)
...
FC_REFLECT_ENUM(thinkyoung::blockchain::TransactionType,
	...
	FC_REFLECT(thinkyoung::blockchain::TransactionSendingState, (seedAddr)(sentTime))
	...
	//FC_REFLECT(thinkyoung::blockchain::Transaction, (expiration)(trx_num)(reserved)(alp_account)(alp_inport_asset)(operations)(result_trx_type)(result_trx_id))
