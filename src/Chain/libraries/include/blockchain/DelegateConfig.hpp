...
#define ALP_BLOCKCHAIN_AVERAGE_TRX_SIZE ((double)512) // just a random assumption used to calibrate TRX per SEC
...
namespace thinkyoung {
    namespace blockchain {
        ...
        struct DelegateConfig
        {
            ...
            uint32_t            block_max_size = (uint32_t)ALP_BLOCKCHAIN_MAX_BLOCK_SIZE;
            fc::microseconds    block_max_production_time = fc::milliseconds(10);

            uint32_t            transaction_max_size = (uint32_t)ALP_BLOCKCHAIN_MAX_TRX_SIZE;
