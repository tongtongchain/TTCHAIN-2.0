    ...
    namespace blockchain {
        ...
        namespace detail
        {
            ...
            public:
                ...
                */
                void   store_and_index(const BlockIdType& id, const FullBlock& blk);
                ...
                */
				...
				void										remove_pending_feeindex(const TransactionIdType id);
                /*
				...
				*/
				vector<EventOperation>                      get_events(uint64_t block_index, const thinkyoung::blockchain::TransactionIdType& trx_id_type);
                ...
                * @return std::vector<BlockIdType>
                */
                std::vector<BlockIdType>                  fetch_blocks_at_number(uint64_t block_num);
                ...
                * @return void
                */
                void                                        update_active_delegate_list(const uint64_t block_num,
                    const PendingChainStatePtr& pending_state)const;
                ...
                * @return void
                */
                void                                        update_random_seed(const DigestType& new_secret,
                    const PendingChainStatePtr& pending_state,
                    oBlockEntry& block_entry)const;
                ...
                * @return void
                */
                void                                        save_undo_state(const uint64_t block_num,
                    const BlockIdType& block_id,
                    const PendingChainStatePtr& pending_state);
                ...
                */
				...
				//void                                        update_my_head_block(const SignedBlockHeader& block_header);
                ...
                */
				...
				thinkyoung::db::LevelMap < TransactionIdType, TransactionSendingState>      _sending_trx_state_db;


				//new blocks that waiting for approval.
				//thinkyoung::db::LevelMap<BlockIdType, FullBlock>						 _pending_block_db;
				//thinkyoung::db::LevelMap<BlockIdType, FullBlock>						 _cache_block_db;
				//thinkyoung::db::LevelMap<BlockIdType, FullBlock>						 _missing_block_db;
				//thinkyoung::db::LevelMap<BlockIdType, int>								 _reply_db;
				thinkyoung::db::LevelMap<int, SignedBlockHeader>						 _my_last_block;
                ...
                //thinkyoung::db::LevelMap<uint64_t, vector<BlockIdType>>                         _fork_number_db; // All siblings
                ...
                thinkyoung::db::LevelMap<uint64_t, BlockIdType>                                 _block_num_to_id_db; // Current chain

				thinkyoung::db::LevelMap<BlockIdType, FullBlock1>                               _block_id_to_full_block1;
				thinkyoung::db::LevelMap<uint32_t, BlockIdType>                                 _block_num_to_id_db1; // Current chain
				thinkyoung::db::LevelMap<uint32_t, uint64_t>                                 _nodeindex_to_produced;

				thinkyoung::db::LevelMap<BlockIdType, BlockEntry>                             _block_id_to_block_entry_db; // Statistics

                /* Current primary state */
				uint16_t																	 _nodeindex = 0xffff;
				//BlockIdType                                                               _my_head_block_id;
				//SignedBlockHeader                                                         _my_head_block_header;
