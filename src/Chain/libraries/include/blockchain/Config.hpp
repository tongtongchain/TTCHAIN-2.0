...
#define ALP_BLOCKCHAIN_BLOCK_INTERVAL_SEC_V2                int64_t(1)
...
#define ALP_BLOCKCHAIN_MIN_MESSAGE_FEE_COE                  0
...
#define ALP_DEFAULT_TRANSACTION_FEE                         0
//#define ALP_DEFAULT_TRANSACTION_FEE                         5000
#define ALP_DEFAULT_MIN_TRANSACTION_AMOUNT                  10 // 设置最低手续费为0.0001
#define ALP_DEFAULT_MIN_TRANSACTION_FEE                     0 // 设置最低手续费为0.00001
//#define ALP_DEFAULT_MIN_TRANSACTION_FEE                      5000 // 设置最低手续费为0.00001 0.05, modified on 5-7-2019
...
//#define ALP_DEFAULT_MAX_TRANSACTION_FEE                     5000000 // 设置最高手续费为1000 modified on 5-7-2019
#define ALP_DEFAULT_MAX_TRANSACTION_FEE                     50000000 // 设置最高手续费为1000 modified on 8-7-2019
#define ALP_DEFAULT_TRANSACTION_FEE_RATIO					double(0.00500) //手续费比例0.003 modified on 5-7-2019
...
#define ALP_BLOCKCHAIN_DEFAULT_RELAY_FEE                    0 // XTS //mod zxj  1000 ->1
