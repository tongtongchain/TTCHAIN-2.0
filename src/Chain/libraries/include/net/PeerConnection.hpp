...
namespace thinkyoung {
    namespace net
    {
        ...
        public:
            ...
            uint64_t number_of_unfetched_item_ids; /// number of items in the blockchain that follow ids_of_items_to_get but the peer hasn't yet told us their ids
            ...
            uint64_t last_block_number_delegate_has_seen; /// the number of the last block this peer has told us about that the delegate knows (ids_of_items_to_get[0] should be the id of block [this value + 1])
        ...
        public:
			...
			bool is_seed();
			bool is_status();
			bool is_match_endpoint(string endpoint);
			...
			fc::optional<fc::ip::endpoint> get_remote_endpoint_1();
