...
namespace thinkyoung {
    namespace blockchain {
		...
		const OperationTypeEnum UpdateTransferConfigOperation::type = update_transfer_conifg;
        static bool first_chain = []()->bool{
			...
			thinkyoung::blockchain::OperationFactory::instance().register_operation<UpdateTransferConfigOperation>();
            return true;
        }();
