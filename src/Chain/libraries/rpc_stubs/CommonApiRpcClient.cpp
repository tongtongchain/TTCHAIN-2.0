...
namespace thinkyoung {
    namespace rpc_stubs {
        ...
        std::vector<thinkyoung::blockchain::AlpTrxidBalance> CommonApiRpcClient::blockchain_get_alp_account_balance_entry(uint64_t block_num)
        {
        ...
        uint32_t CommonApiRpcClient::blockchain_get_total_seednode() const
        {
            fc::variant result = get_json_connection()->async_call("blockchain_get_total_seednode", std::vector<fc::variant>{}).wait();
            return result.as<uint32_t>();
        }
        uint32_t CommonApiRpcClient::blockchain_get_total_status_nodes() const
        {
            fc::variant result = get_json_connection()->async_call("blockchain_get_total_status_nodes", std::vector<fc::variant>{}).wait();
            return result.as<uint32_t>();
        }
        uint32_t CommonApiRpcClient::status_node_get_index() const
        {
            fc::variant result = get_json_connection()->async_call("status_node_get_index", std::vector<fc::variant>{}).wait();
            return result.as<uint32_t>();
        }
        uint32_t CommonApiRpcClient::status_node_unlocked_wallets_count() const
        {
            fc::variant result = get_json_connection()->async_call("status_node_unlocked_wallets_count", std::vector<fc::variant>{}).wait();
            return result.as<uint32_t>();
        }
        uint64_t CommonApiRpcClient::blockchain_get_block_count(const string& nodeindex) const
        {
            fc::variant result = get_json_connection()->async_call("blockchain_get_block_count", std::vector<fc::variant>{fc::variant(nodeindex)}).wait();
            return result.as<uint64_t>();
        }
		uint64_t CommonApiRpcClient::status_node_close_wallet(const string& index) const
        {
			fc::variant result = get_json_connection()->async_call("status_node_close_wallet", std::vector<fc::variant>{fc::variant(index)}).wait();
			return result.as<uint64_t>();
		}
		uint64_t CommonApiRpcClient::status_node_lock_wallet(const string& index) const
        {
			fc::variant result = get_json_connection()->async_call("status_node_lock_wallet", std::vector<fc::variant>{fc::variant(index)}).wait();
			return result.as<uint64_t>();
		}
		...
		thinkyoung::blockchain::oFullBlockEntry CommonApiRpcClient::blockchain_get_block(const std::string& block) const
		{
			fc::variant result = get_json_connection()->async_call("blockchain_get_block", std::vector<fc::variant>{fc::variant(block)}).wait();
			return result.as<thinkyoung::blockchain::oFullBlockEntry>();
		}
		thinkyoung::blockchain::oFullBlockEntry CommonApiRpcClient::blockchain_get_fullblock(const std::string& block) const
		{
			fc::variant result = get_json_connection()->async_call("blockchain_get_fullblock", std::vector<fc::variant>{fc::variant(block)}).wait();
			return result.as<thinkyoung::blockchain::oFullBlockEntry>();
		}
		std::vector<oFullBlockEntry> CommonApiRpcClient::blockchain_get_fullblock_list(const std::string& block, const uint32_t limit) const
		{
			fc::variant result = get_json_connection()->async_call("blockchain_get_fullblock_list", std::vector<fc::variant>{fc::variant(block), fc::variant(limit)}).wait();
			return result.as<std::vector<thinkyoung::blockchain::oFullBlockEntry>>();
		}
        ...
        std::vector<thinkyoung::blockchain::AccountEntry> CommonApiRpcClient::blockchain_list_active_delegates(uint64_t first /* = fc::json::from_string("0").as<uint32_t>() */, uint64_t count /* = fc::json::from_string("20").as<uint32_t>() */) const
        {
        ...
        std::vector<thinkyoung::blockchain::AccountEntry> CommonApiRpcClient::blockchain_list_delegates(uint64_t first /* = fc::json::from_string("0").as<uint32_t>() */, uint64_t count /* = fc::json::from_string("20").as<uint32_t>() */) const
        {
        ...
        std::vector<thinkyoung::blockchain::BlockEntry> CommonApiRpcClient::blockchain_list_blocks(uint64_t max_block_num /* = fc::json::from_string("-1").as<uint32_t>() */, uint64_t limit /* = fc::json::from_string("20").as<uint32_t>() */)
        {
        ...
        std::vector<std::string> CommonApiRpcClient::blockchain_list_missing_block_delegates(uint64_t block_number)
        {
        ...
        std::string CommonApiRpcClient::blockchain_export_fork_graph(uint64_t start_block /* = fc::json::from_string("1").as<uint32_t>() */, uint64_t end_block /* = fc::json::from_string("-1").as<uint32_t>() */, const thinkyoung::blockchain::FilePath& filename /* = fc::json::from_string("\"\"").as<thinkyoung::blockchain::FilePath>() */) const
        {
        ...
        std::map<uint64_t, std::vector<thinkyoung::blockchain::ForkEntry>> CommonApiRpcClient::blockchain_list_forks() const
        {
            fc::variant result = get_json_connection()->async_call("blockchain_list_forks", std::vector<fc::variant>{}).wait();
            return result.as<std::map<uint64_t, std::vector<thinkyoung::blockchain::ForkEntry>>>();
        }
        std::vector<thinkyoung::blockchain::SlotEntry> CommonApiRpcClient::blockchain_get_delegate_slot_entrys(const std::string& delegate_name, uint64_t limit /* = fc::json::from_string("\"10\"").as<uint32_t>() */) const
        {
        ...
        std::vector<thinkyoung::blockchain::EventOperation> CommonApiRpcClient::blockchain_get_events(const std::string& block_number, const thinkyoung::blockchain::TransactionIdType& trx_id) const
        {
        ...
        std::vector<fc::variant_object> CommonApiRpcClient::status_nodes_info(bool not_firewalled /* = fc::json::from_string("false").as<bool>() */) const
        {
            fc::variant result = get_json_connection()->async_call("status_nodes_info", std::vector<fc::variant>{fc::variant(not_firewalled)}).wait();
            return result.as<std::vector<fc::variant_object>>();
        }
        std::vector<fc::variant_object> CommonApiRpcClient::status_node_unlocked_wallets_list(bool not_firewalled /* = fc::json::from_string("false").as<bool>() */) const
        {
            fc::variant result = get_json_connection()->async_call("status_node_unlocked_wallets_list", std::vector<fc::variant>{fc::variant(not_firewalled)}).wait();
            return result.as<std::vector<fc::variant_object>>();
        }
        ...
        std::vector<thinkyoung::wallet::PrettyTransaction> CommonApiRpcClient::wallet_account_transaction_history(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */, const std::string& asset_symbol /* = fc::json::from_string("\"\"").as<std::string>() */, int64_t limit /* = fc::json::from_string("0").as<int64_t>() */, uint64_t start_block_num /* = fc::json::from_string("0").as<uint64_t>() */, uint64_t end_block_num /* = fc::json::from_string("-1").as<uint64_t>() */) const
        {
        ...
        std::vector<thinkyoung::wallet::PrettyTransaction> CommonApiRpcClient::wallet_transaction_history_splite(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */, const std::string& asset_symbol /* = fc::json::from_string("\"\"").as<std::string>() */, int64_t limit /* = fc::json::from_string("0").as<int32_t>() */, int32_t transaction_type /* = fc::json::from_string("\"2\"").as<int32_t>() */) const
        {
        ...
        void CommonApiRpcClient::wallet_rescan_blockchain(uint64_t start_block_num /* = fc::json::from_string("0").as<uint32_t>() */, uint32_t limit /* = fc::json::from_string("-1").as<uint32_t>() */)
        {
